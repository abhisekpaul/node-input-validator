...
class Mix extends DateRules {
    ...
    async validateDomain(field, value) {
        return v.isFQDN(value);
    }

    async validateHash(field, value, hash) {
        return v.isHash(value, hash);
    }

    async validateHexColor(field, value) {
        return v.isHexColor(value);
    }

    async validateHex(field, value) {
        return v.isHexadecimal(value);
    }

    async validateIso8601(field, value) {
        return v.isISO8601(value);
    }

    async validateMacAddress(field, value) {
        return v.isMACAddress(value);
    }

    async validatePhoneNumber(field, value) {
        //@ts-ignore
        return v.isMobilePhone(value);
    }

    async validateMongoId(field, value) {
